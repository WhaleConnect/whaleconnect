...
class Task {
    ...
    struct PromiseType : std::conditional_t<_isVoid, PromiseTypeVoid, PromiseTypeValue<T>> {
        ...
        auto final_suspend() const noexcept {
            ...
            struct Awaiter {
                /// <summary>
                /// Called first when this awaiter is awaited.
                /// </summary>
                ...
                /// <summary>
                /// Called last when this awaiter is awaited.
                /// </summary>
...
public:
    ...
    /// <summary>
    /// Called first when this task is awaited. This determines whether the coroutine needs to be suspended.
    /// </summary>
    ...
    /// Called when the coroutine is suspended.
    /// </summary>
    /// <param name="current">A coroutine handle to the current coroutine</param>
    ...
    /// <summary>
    /// Called last when this task is awaited. This is the result of the entire co_await expression.
    /// </summary>
